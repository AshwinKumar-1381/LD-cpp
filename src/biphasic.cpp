...
void program::simulation(sysInput *Input)
{
    ...
    runNVE *RUN1 = new runNVE(1, 1000, Input->dt, 20000, 20000, true);
    RUN1 -> integrateNVE(ATOMS, BOX, INTERACTIONS, Input);
    
    run_style *RUN2 = new run_style(2, 50000, Input->dt, 20000, 20000, true, true, true, 0.5*BOX->boxLength_x);
    KMC_poisson *KMC;
